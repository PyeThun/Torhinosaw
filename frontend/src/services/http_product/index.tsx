...
async function GetProductType() {
  ...
  async function GetPlayment() {
    ...
    let res = await fetch(`${apiUrl}/getPaymentUpdate`, requestOptions)
      .then((response) => response.json())
      .then((res) => {
        if (res.data) {
          return res.data;
  ...
  async function GetCustomer() {
    ...
    let res = await fetch(`${apiUrl}/getCustomerUpdate`, requestOptions)
      .then((response) => response.json())
      .then((res) => {
        if (res.data) {
          return res.data;
  ...
  async function Getstatus() {
    ...
    let res = await fetch(`${apiUrl}/getStatusUpdate`, requestOptions)
      .then((response) => response.json())
      .then((res) => {
        if (res.data) {
          return res.data;
  ...
  async function GetPaymentById(id: Number | undefined) {
    ...
    let res = await fetch(`${apiUrl}/payment_pdate/${id}`, requestOptions)
      .then((response) => response.json())
      .then((res) => {
        if (res.data) {
          return res.data;
  ...
  async function UpdatePayment(data: ProductInterface) {
    const requestOptions = {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(data),
    ...
    let res = await fetch(`${apiUrl}/payment_update`, requestOptions)
      .then((response) => response.json())
      .then((res) => {
        if (res.data) {
          return { status: true, message: res.data };
